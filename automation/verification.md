...
| Резюме DOCX | Одна страница, рендеринг и визуальная проверка выполнены | docs/Danil_Silin_QA_Resume.docx и PDF |
...
Windows, Firefox/WebKit и новая ручная проверка внешнего DemoQA в рамках указанного локального прогона не выполнялись. GitHub Actions отдельно выполнил API/SQL наборы на Python 3.11 и 3.12, а также UI набор на Chromium: [проверка pull request](https://github.com/silindanil01-ops/qa-portfolio/actions/runs/35781765519). [GitHub Pages опубликован](https://silindanil01-ops.github.io/qa-portfolio/). Эти результаты относятся к учебному стенду, не к нативному мобильному приложению.
